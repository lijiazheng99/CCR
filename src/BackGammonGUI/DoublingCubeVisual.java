...
public class DoublingCubeVisual extends GridPane {
    ...
    public void inputDoublingDiceImages() {
        try {
            images[0] = new Image(new FileInputStream("src//resources//doubleCube_2.png"), 55, 55, false, false) ;
            images[1] = new Image(new FileInputStream("src//resources//doubleCube_4.png"),55,55,false,false);
            images[2] = new Image(new FileInputStream("src//resources//doubleCube_8.png"),55,55,false,false);
            images[3] = new Image(new FileInputStream("src//resources//doubleCube_16.png"),55,55,false,false);
            images[4] = new Image(new FileInputStream("src//resources//doubleCube_32.png"),55,55,false,false);
            images[5] = new Image(new FileInputStream("src//resources//doubleCube_64.png"),55,55,false,false);
