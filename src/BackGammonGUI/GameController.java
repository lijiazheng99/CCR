...
public class GameController
{
    ...
    private GridPane initControlVisual()
    {
        ...
        piplabels[12] =  new Label("2");
        piplabels[13] =  new Label("2");
        piplabels[14] =  new Label("2");
        piplabels[15] =  new Label("2");
        piplabels[16] =  new Label("2");
        piplabels[17] =  new Label("2");
        piplabels[18] =  new Label("2");
        piplabels[19] =  new Label("2");
        piplabels[20] =  new Label("2");
        piplabels[21] =  new Label("2");
        piplabels[22] =  new Label("2");
        piplabels[23] =  new Label("2");
